var L8_SR = ee.ImageCollection("LANDSAT/LC08/C01/T1_SR"),
    ...
    Indo18_Kab = ee.FeatureCollection("users/rarasati/SHP2018/SHP_ProvKabKot_2018"),
    ModFs_2020145_JwBl = ee.Image("users/salmanddd14/Img/ModFase_1452020_jwbl"),
    Indo_Kc = ee.FeatureCollection("users/salmanddd14/shp/Indo10_Kc"),
    DI_Rentang = ee.FeatureCollection("users/salmanddd14/shp/DI_Rentang"),
    Jln_Indo = ee.FeatureCollection("users/gilangaulia1707226/Ruas_Jalan_Indo");
...
Thn = 2021; Thn1 = Thn-1; Pd = 10;  // Pd bisa diganti : 5,10,15,30 
FaseTampil ='S1' ; 
